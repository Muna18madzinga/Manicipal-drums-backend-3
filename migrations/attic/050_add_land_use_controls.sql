-- Add Zone-Land Use Controls Migration
...
-- Update zones with scale categories based on zone types
...
CREATE TABLE IF NOT EXISTS zone_land_use_controls (
    ...
    land_use_group_id UUID NOT NULL REFERENCES land_use_groups(group_id) ON DELETE CASCADE,
...
BEGIN
    ...
    SELECT group_id INTO sample_land_use_id FROM land_use_groups WHERE development_category = 'permitted' LIMIT 1;
