...
exports.createDataCleaningRoutes = createDataCleaningRoutes;
const dataCleaningController_1 = require("../../controllers/admin/dataCleaningController");
function createDataCleaningRoutes(server, pool) {
    const dataCleaningController = new dataCleaningController_1.DataCleaningController(pool);
