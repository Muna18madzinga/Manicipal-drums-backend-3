...
exports.createQmlParserRoutes = createQmlParserRoutes;
const qmlParserController_1 = require("../../controllers/admin/qmlParserController");
function createQmlParserRoutes(server, pool) {
    const qmlParserController = new qmlParserController_1.QmlParserController(pool);
...
//# sourceMappingURL=qmlParser.js.map