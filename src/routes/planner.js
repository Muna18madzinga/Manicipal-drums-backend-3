...
async function plannerRoutes(fastify) {
  ...
  fastify.get('/planner/notifications', { preHandler: requireAuth(fastify) }, async (request, reply) => {
  ...
  fastify.patch('/planner/notifications/:id/read', { preHandler: requireAuth(fastify) }, async (request, reply) => {
