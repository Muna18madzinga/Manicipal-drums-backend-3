...
export class AdminUserModel {
  ...
  async updateRole(id: string, role: AdminRole, permissions?: Record<string, any>): Promise<AdminUser> {
  ...
  private getDefaultPermissions(role: AdminRole): Record<string, any> {
    switch (role) {
