...
import { Pool } from 'pg';
import { ApprovalWorkflowController } from '../../controllers/admin/approvalWorkflowController';

export function createApprovalWorkflowRoutes(server: FastifyInstance, pool: Pool) {
  const approvalWorkflowController = new ApprovalWorkflowController(pool);
