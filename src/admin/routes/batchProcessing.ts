...
import { Pool } from 'pg';
import { BatchProcessingController } from '../../controllers/admin/batchProcessingController';

export function createBatchProcessingRoutes(server: FastifyInstance, pool: Pool) {
  const batchProcessingController = new BatchProcessingController(pool);
